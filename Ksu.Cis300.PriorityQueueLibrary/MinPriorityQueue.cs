...
{
    /// <summary>
    /// Finds and removes the LeftistTree Node with the minimum priority
    /// </summary>
    ...
    public class MinPriorityQueue<TPriority, TValue> where TPriority : IComparable<TPriority>
    {
            ...
            LeftistTree<KeyValuePair<TPriority, TValue>> h2)
        {
            ...
            {
                int leftistHeap = h1.Data.Key.CompareTo(h2.Data.Key);
                if(leftistHeap <= 0)
                {
                    LeftistTree<KeyValuePair<TPriority, TValue>> temp = 
                        new LeftistTree<KeyValuePair<TPriority, TValue>>(h1.Data,h1.LeftChild ,Merge(h1.RightChild,h2));
                    return temp;
                }
                else
                {
                    LeftistTree<KeyValuePair<TPriority, TValue>> temp =
                        new LeftistTree<KeyValuePair<TPriority, TValue>>(h2.Data, h2.LeftChild, Merge(h2.RightChild, h1));
                    return temp;
                }
        ...
        /// Implement the get accessor with a block of code that returns a value; i.e.:
        /// </summary>
        public TPriority MinimumPriority
        {
            get
            {
                ...
                TPriority min = _elements.Data.Key;
                return min;
        ...
        /// <summary>
        /// to remove the element with minimum priority and return that element.
        /// </summary>
        /// <returns></returns>
